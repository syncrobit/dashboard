<div id="add-hotspot-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addHotspotLabel" aria-hidden="true"
    style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title m-0" id="addHotspotLabel">Add Hotspot</h4>
