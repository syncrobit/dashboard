	...
	<body class="main-body dark-theme">
		...
		<div class="page">
			...
			<div class="main-error-wrapper  page page-h ">
				<img src="{{SB_THEME::getResourcesImage(media/500.png)}}" class="error-page" alt="error">
				<h2>Oopps. Something went wrong.</h2>
				<h6>We aplogize for the inconvenience, we're working on it.</h6>
